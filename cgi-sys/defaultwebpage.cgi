    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                ...
                <a href="mailto:webmaster@naturextracts.com" target="_blank" rel="noopener noreferrer" title="Click this link to contact the host" id="dynamicProviderLink">
                    webmaster@naturextracts.com
                </a>
            </section>
